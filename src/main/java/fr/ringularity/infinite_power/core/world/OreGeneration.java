package fr.ringularity.infinite_power.core.world;
...
public class OreGeneration {
    ...
    public static void registerOres() {
        ...
        final PlacedFeature placedGlowstoneOre = PlacementUtils.register("glowstone_ore",
                glowstoneOre.placed(commonOrePlacement(100, HeightRangePlacement
        ...
        final PlacedFeature placedBeansOre = PlacementUtils.register("beans_ore",
                beansOre.placed(commonOrePlacement(100, HeightRangePlacement
        ...
        final PlacedFeature placedEggOre = PlacementUtils.register("egg_ore",
                eggOre.placed(commonOrePlacement(100, HeightRangePlacement
